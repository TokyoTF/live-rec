...
export default class Sites {
  ...
  recInit(info) {
    ...
    command
      .setFfmpegPath(info.ffmpegselect)
      .addOptions(
      ...
      .output(`${info.savefolder}/${this.FileDate(info.nametag, info.provider)}.mkv`)
      .on('start', function () {
...
//https://stripchat.com/api/vr/v2/models/username/Fayola__
//streamName
//https://edge-hls.doppiocdn.live/hls/46235577/master/46235577_auto.m3u8
//https://edge-hls.doppiocdn.live/hls/46235577/master/46235577.m3u8
